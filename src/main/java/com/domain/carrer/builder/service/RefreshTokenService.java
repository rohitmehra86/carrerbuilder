package com.domain.carrer.builder.service;
...
import com.domain.carrer.builder.repository.RefreshTokenRepository;
import com.domain.carrer.builder.repository.UserRepository;

@Service
public class RefreshTokenService {
	@Value("${carrerBuilder.app.jwtRefreshExpirationMs}")
